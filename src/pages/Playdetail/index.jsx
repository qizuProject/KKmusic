...
export default class Playdetail extends Component {
  ...
  async componentDidMount() {
    try {
      ...
      // 发送请求 获取歌曲详情信息
      let musicInfo = await reqMusicInfo(rid);
      // 更新数据
      this.setState({
        musicInfo: musicInfo.data,
      });
      // 获取歌词
      let musicLrcList = await reqMusicLrcList(rid);
      console.log(musicLrcList);
    ...
    return (
      <>
        <div className="container">
          ...
          <Playcontrol timeUpdate={this.timeUpdate} mid={rid}></Playcontrol>
        </div>
      </>
    );
  }
