...
class Playcontrol extends Component {
  ...
  async componentDidMount() {
    ...
    // 请求歌曲信息  需要id  这里没有
    this.getmusicinfo(this.props.mid);
    this.playSong(this.props.mid);
            ...
            <div className="posi_re">
              ...
              <div className="control">
                ...
                <div className="con_l flex_c">
                  ...
                  <img src={musicInfo.albumpic} className="song_img" alt="hh" />
